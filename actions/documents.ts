...
//Trả về danh sách tài liệu mà user sở hữu hoặc được chia sẻ.
...
//Trả về danh sách người dùng được chia sẻ tài liệu đó.
...
//Trả về một tài liệu cụ thể nếu user có quyền truy cập.
